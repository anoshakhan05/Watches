        ...
        <footer className="mt-20 border-t border-slate-900 bg-background-dark py-12 px-6">
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
                <div className="flex items-center gap-2 opacity-50">
                    ...
                    <span className="text-sm font-bold tracking-widest">AETERNA MANUFACTURE</span>
                </div>
                <div className="flex gap-12 text-[10px] font-bold tracking-[0.3em] text-slate-500">
                    <a href="#" className="hover:text-primary transition-colors">PRIVACY POLICY</a>
                    <a href="#" className="hover:text-primary transition-colors">TERMS OF SERVICE</a>
                    <Link to="/contact" className="hover:text-primary transition-colors">CONTACT BOUTIQUE</Link>
                </div>
